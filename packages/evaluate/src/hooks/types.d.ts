...
export type EvalHandler = (this: {
    ...
    type: string;
    position: number;
}, input: any, environment: Focus['environment']) => Promise<void> | void;
 ...
 * time-boxing expressions.
 */
(hook: `${HookTypes.EvalExit}`, handler: HookHandler<HookTypes.EvalExit>) => Context;
export interface HookRegistry<Context> extends TapEvalEntry<Context>, TapEvalExit<Context> {
