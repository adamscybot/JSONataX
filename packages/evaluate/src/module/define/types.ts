...
import {
  type DeepReadonly,
  type ReadonlyFunction,
} from '../../lib/immutability.js'

import {
  type ImplFromSignature,
  type ValidSignature,
...
export interface DefinePluginBuilder {
  ...
  // hookEvaluator: HookRegistry<DefinePluginBuilder>

  // hookPipeline: HookRegistry<DefinePluginBuilder>
...
export type JsonataModuleFnDefImpl = ReadonlyFunction<
  Parameters<Expression['registerFunction']>[1]
>
...
export type JsonataModuleDef = {
  ...
  // basicApply?(expression: Expression): Expression
}
