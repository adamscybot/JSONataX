 ...
 */
export declare const secureEnv: (opts?: SecureEnvOpts) => import("../../lib/immutability.js")._DeepReadonlyObject<{
    id: string;
    description?: string | undefined;
    exports: readonly import("../define/types.js").JsonataModuleFnDef[];
    hooks: readonly import("../define/types.js").JsonataModuleHookDef[];
}>;
