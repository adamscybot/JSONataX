...
/**
 * This is a module which is intended to be used with
 * [modular-jsonata](https://github.com/adamscybot/modular-jsonata). It extends
 * JSONAta's base functionality.
 *
 * Non-recommended escape hatches to apply the module without
 * [modular-jsonata](https://github.com/adamscybot/modular-jsonata) are
 * available.
 *
